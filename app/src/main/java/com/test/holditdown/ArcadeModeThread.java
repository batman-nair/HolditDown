 ...
 */
public class ArcadeModeThread extends Thread {

    private static final String TAG = ArcadeModeThread.class.getSimpleName();
    ...
    public ArcadeModeThread(SurfaceHolder surfaceHolder, ArcadeMode gamePanel) {
        super();
